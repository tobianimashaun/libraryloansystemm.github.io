...
<body class="login" style="margin-top: -20px;">
    ...
    <div class="login_wrapper">
            ...
            if(isset($_POST['submit1'])){
              ...
              mysqli_query($link, "insert into student_registration values('','$_POST[firstname]','$_POST[lastname]','$_POST[username]','$_POST[password]','$_POST[email]','$_POST[contact]','$_POST[matric]' ,'no')");
